...
export class CartographerWasm {
    free(): void;
    [Symbol.dispose](): void;
    add_edges(edges_json: string): void;
...
export function check_the_grail(input: string): string;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly __wbg_cartographerwasm_free: (a: number, b: number) => void;
    readonly cartographerwasm_add_edges: (a: number, b: number, c: number) => [number, number];
